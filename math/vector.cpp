...
template<typename T> Vector2<T>::Vector2() { x = y = 0.0; }

template<typename T> Vector2<T>::Vector2(T a) { x = y = a; }
...
template<typename T> Vector2<T> &Vector2<T>::operator *= (const T s) {
...
template<typename T> T Vector2<T>::lengthSquared() {
...
template<typename T> Vector3<T>::Vector3() { x = y = z = 0.0; }

template<typename T> Vector3<T>::Vector3(T a) { x = y = z = a; }

template<typename T> Vector3<T>::Vector3(T X, T Y, T Z) { x = X; y = Y; z = Z; }

template<typename T> Vector3<T>::Vector3(const Vector3 &v) { x = v.x; y = v.y; z = v.z; }
...
template<typename T> Vector3<T> &Vector3<T>::operator *= (const T s) {
...
template<typename T> T Vector3<T>::lengthSquared() {
